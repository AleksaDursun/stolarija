...
/**
 * Created by PhpStorm.
 * Nikola Kukric <nikola@2amigos.us>
 * Date: 21.03.2017.
 * Time: 22:27
 */

namespace common\components\timeago;
...
class TimeAgo
{
     ...
     * @throws Exception
     */
    public static function createInstance($timezone = null, $language = 'en')
    {
        if (empty(static::$_instance)) {
            static::$_instance = new self($timezone, $language);
        }
    ...
    public function inWords($past, $now = "now")
    {
        ...
        $past = is_int($past) ? $past : strtotime($past);
