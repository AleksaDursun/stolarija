...
class FileBehavior extends Behavior
{
    ...
    public function saveFromPath($path, $overwrite = true)
    {
        $this->_tmpFile = $path;
     ...
     * @return bool
     */
    public function saveOnStorageAs($storageKey)
    {
        return $this->getResourceManager()->write($storageKey, $this->getLocalFile());
    }
