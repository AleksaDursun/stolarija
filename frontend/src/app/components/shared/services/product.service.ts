...
const products = LocalStorageService.getItem('compareItem') ? JSON.parse(LocalStorageService.getItem('compareItem')) : [];
...
public hasProduct(product: Product): boolean {
 ...
 public addToCompare(product: Product): Product | boolean {
  ...
  LocalStorageService.setItem('compareItem', JSON.stringify(products));
  return item;
}
